...
setAs("ExpressionSet", "RangedSElite", function(from)
{
    makeSEliteFromExpressionSet(from)
})

setAs("ExpressionSet", "SElite", function(from)
{
    as(makeSEliteFromExpressionSet(from), "SElite")
})

setAs("RangedSElite", "ExpressionSet",
      function(from)
{
...
setAs("SElite", "ExpressionSet", function(from)
    as(as(from, "RangedSElite"), "ExpressionSet")
)
